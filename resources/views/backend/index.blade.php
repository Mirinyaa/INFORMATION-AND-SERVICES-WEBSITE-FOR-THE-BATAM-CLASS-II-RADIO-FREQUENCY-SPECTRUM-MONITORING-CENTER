							...
							<div class="col-xxl-3 col-sm-6 col-12">
								<div class="card mb-4">
									<div class="card-body d-flex align-items-center p-0">
										...
										<div class="py-4">
											<h5 class="text-secondary fw-light m-0">Total Pegawai</h5>
											<h1 class="m-0">{{$countPegawai}}</h1>
										</div>
									</div>
								</div>
							</div>
							...
							<div class="col-lg-4 col-sm-6 col-12">
								<div class="card mb-4">
									<div class="card-body d-flex align-items-center p-0">
										...
										<div class="py-4">
											<h5 class="text-secondary fw-light m-0">Menunggu Persetujuan Pengajuan Pinjam Barang</h5>
											<h1 class="m-0">{{ $countPegawaiPengajuanPinjam }}</h1>
										</div>
									</div>
								</div>
							</div>
